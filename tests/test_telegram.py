"""
Tests for embedded_vehicle.telegram.bot — TelegramBot with mocked python-telegram-bot.
"""
...
from embedded_vehicle.telegram.bot import AlertMessage, TelegramBot
...
async def test_telegram_cmd_start(mock_telegram_app: MagicMock) -> None:
    ...
    assert "Hermes Vehicle Bot" in text
