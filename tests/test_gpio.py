"""
Tests for embedded_vehicle.gpio.controller — GPIOController with mocked lgpio.
"""
...
from embedded_vehicle.gpio.controller import GPIOController, InputName, RelayName
