"""
Tests for embedded_vehicle.camera.recorder — CameraRecorder with mocked hardware.
"""
...
from embedded_vehicle.camera.recorder import CameraRecorder, CircularBuffer, VideoSegment
