...
─────────────────────
Hardware bench test script for Embedded-Vehicle integration.

Run this on the Raspberry Pi before vehicle installation to verify:
1. OBD-II connection
2. GPS fix
3. IMU sampling
...
async def test_camera() -> bool:
    ...
    try:
        ...
        path = "/tmp/vehicle_test_snapshot.jpg"
...
async def test_audio() -> bool:
    ...
    try:
        import subprocess
        # Record 3 seconds
        rec_path = "/tmp/vehicle_test_audio.wav"
...
async def main() -> None:
    parser = argparse.ArgumentParser(description="Embedded-Vehicle hardware bench test")
