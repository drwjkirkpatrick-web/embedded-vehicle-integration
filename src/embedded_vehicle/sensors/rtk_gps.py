"""
embedded_vehicle/sensors/rtk_gps.py
───────────────────────────
...
if TYPE_CHECKING:
    from embedded_vehicle.core.config import RTKGPSConfig

logger = logging.getLogger("vehicle.sensors.rtk_gps")
        ...
        while self._running:
            try:
                ...
                req = (
                    ...
                    f"User-Agent: embedded-vehicle-rtk/0.1\r\n\r\n"
                )
