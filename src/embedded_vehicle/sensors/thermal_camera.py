"""
embedded_vehicle/sensors/thermal_camera.py
──────────────────────────────────
...
if TYPE_CHECKING:
    from embedded_vehicle.core.config import ThermalCameraConfig

logger = logging.getLogger("vehicle.sensors.thermal")
