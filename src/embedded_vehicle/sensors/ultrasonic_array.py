"""
embedded_vehicle/sensors/ultrasonic_array.py
────────────────────────────────────
...
if TYPE_CHECKING:
    from embedded_vehicle.core.config import UltrasonicConfig

logger = logging.getLogger("vehicle.sensors.ultrasonic")
