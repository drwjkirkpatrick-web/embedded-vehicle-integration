"""
embedded_vehicle/camera/picamera2_backend.py
──────────────────────────────────────
...
when picamera2 is available on Raspberry Pi.

Features:
- H.264 hardware encode via V4L2 on Pi
...
logger = logging.getLogger("vehicle.camera.picamera2")
