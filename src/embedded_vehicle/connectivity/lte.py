"""
embedded_vehicle/connectivity/lte.py
────────────────────────────
...
if TYPE_CHECKING:
    from embedded_vehicle.core.config import LTEConfig

logger = logging.getLogger("vehicle.connectivity.lte")
...
class LTEController:
    ...
    async def mqtt_connect(self, broker: str, port: int = 1883, client_id: str = "vehicle-pi") -> bool:
