"""
embedded_vehicle/gpio/controller.py
───────────────────────────
GPIO relay control and digital input monitoring for Pi.

Uses lgpio (Pi compatible) instead of the deprecated RPi.GPIO.
Handles:
...
class GPIOController:
    """Pi GPIO controller using lgpio for relays, inputs, and SPI ADC."""
