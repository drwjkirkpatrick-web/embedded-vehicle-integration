"""
embedded_vehicle/display/dashboard.py
─────────────────────────────
OpenGL ES / Kivy dashboard GUI rendered on Pi → HDMI → JoyBring head unit.
...
- Hardware-accelerated via Pi GPU (OpenGL ES 3.1)
...
To run standalone:
    python -m embedded_vehicle.display.dashboard
"""
...
logger = logging.getLogger("vehicle.display.dashboard")
...
class Dashboard:
    ...
    async def start(self) -> None:
        ...
        try:
            ...
            self._kivy_app = VehicleDashboardApp(self)
