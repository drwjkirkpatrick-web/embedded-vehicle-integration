"""
embedded_vehicle/display/steering_wheel.py
─────────────────────────────────
Steering wheel control (SWC) button decoder for Toyota vehicle.

Most 1996 vehicles didn't have steering wheel audio controls, but aftermarket
...
logger = logging.getLogger("vehicle.display.swc")
...
class SteeringWheelController:
    ...
    async def _emit_button(self, name: str, voltage: float) -> None:
        ...
        from embedded_vehicle.display.joybring import SteeringWheelButton
