"""
embedded_vehicle/display/touch_input.py
───────────────────────────────
...
logger = logging.getLogger("vehicle.display.touch")
...
class TouchInputHandler:
    ...
    def _emit(self, points: list[dict[str, int]]) -> None:
        ...
        from embedded_vehicle.display.joybring import TouchPoint, TouchEventType
        touch_points = [
            TouchPoint(
                id=p["id"],
                x=p["x"],
