...
Usage (from assistant.py):
    from embedded_vehicle.audio.whisper_stt import WhisperSTT
...
logger = logging.getLogger("vehicle.audio.whisper")


class WhisperSTT:
    """Local speech-to-text using faster-whisper."""

    # Model size → approximate memory, speed on Pi
