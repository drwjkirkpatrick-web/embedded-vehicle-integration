"""
embedded_vehicle/obd/interface.py
─────────────────────────
OBD-II interface for pre-CAN vehicles (1996-2007) via ELM327 USB adapter.

Supports ISO 9141-2 and KWP2000 protocols. For modern CAN vehicles,
use modern_vehicle/can_multibus.py instead.
...
Usage:
    ...
    obd = OBDInterface()
    await obd.start()
    snapshot = obd.latest_snapshot()
    print(snapshot.speed_kmh, snapshot.rpm)
    await obd.stop()
"""
...
logger = logging.getLogger("vehicle.obd")


# ──────────────────────────────────────────────────────────────────────────────
# PID definitions for 1996 vehicle (5S-FE / 1MZ-FE)
# ──────────────────────────────────────────────────────────────────────────────
