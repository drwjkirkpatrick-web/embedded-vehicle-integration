"""
embedded_vehicle/telegram/bot.py
────────────────────────
...
logger = logging.getLogger("vehicle.telegram")
...
class TelegramBot:
    """Async Telegram bot for Vehicle remote control and alerts."""
    ...
    async def _cmd_start(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        await msg.reply_text(
            "🚗 *Hermes Vehicle Bot*\n"
            "Your 1996 Toyota vehicle is online.\n\n"
            "Commands:\n"
    ...
    async def _cmd_alert_test(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        await self.send_alert(AlertMessage(
            severity="info",
            title="Test Alert",
            body="This is a test alert from your Vehicle.",
        ))
