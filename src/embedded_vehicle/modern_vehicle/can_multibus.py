"""
embedded_vehicle/modern_vehicle/can_multibus.py
───────────────────────────────────────
...
Uses Pi + 2-4x MCP2515 or CAN FD controllers (MCP2517FD) on SPI.
Pi has 4 SPI chip-selects, supporting up to 4 CAN channels.
...
if TYPE_CHECKING:
    from embedded_vehicle.core.config import ModernVehicleConfig

logger = logging.getLogger("vehicle.modern.can")
